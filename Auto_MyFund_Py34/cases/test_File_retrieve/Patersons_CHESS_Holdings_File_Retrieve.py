...
class Autorun(unittest.TestCase):
    ...
    file_name = "Patersons CHESS Holdings File"   
    print(file_name)              
    i = 1
    def test_Patersons_CHESS_Holdings_File(self): 
        try:            
            self.i = self.i + 1
            driver = self.driver
            ...
            if self.i <=2:
                self.test_Patersons_CHESS_Holdings_File()
            else:     
                pass
               
if __name__ == '__main__':
    suite = unittest.TestSuite()        
    suite.addTest(Autorun("test_Patersons_CHESS_Holdings_File"))

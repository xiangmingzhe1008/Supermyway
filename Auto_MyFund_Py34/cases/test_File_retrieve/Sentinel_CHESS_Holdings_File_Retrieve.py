...
class Autorun(unittest.TestCase):
    ...
    file_name = "Sentinel CHESS Holdings File"   
    print(file_name) 
    i = 1
                        
    def test_Sentinel_CHESS_Holdings_File(self): 
        try:            
            self.i = self.i + 1
            driver = self.driver
            self.login()
            ...
            if self.i <=2:
                self.test_Sentinel_CHESS_Holdings_File()
            else:     
                pass
...
if __name__ == '__main__':
    ...
    suite.addTest(Autorun("test_Sentinel_CHESS_Holdings_File"))

...
class Autorun(unittest.TestCase):
    def setUp(self):
        ...
        self.driver = webdriver.Edge(r'../../lib/MicrosoftWebDriver_for_Edge_15063.exe')
    ...
    def test_Template_Posting_Process(self):
        ...
        try:            
            ...
            time.sleep(10)
            mouse_click(self.readconfig()[3],self.readconfig()[4])

...
class Fund_Initiate(unittest.TestCase):
    ...
    def test_noncash_InSpecieRollovers(self):
        try:
            self.i += 1
            driver = self.driver
            self.login()
#             driver.find_element_by_id("ctl00_ContentPlaceHolder1_btnViewFund").click()
            ...
            for line in range(counts):
                ...
                categorys.find_element_by_xpath("//option[@value='19']").click()
                time.sleep(1)
...
if __name__ == '__main__':
    ...
    suite.addTest(Fund_Initiate("test_noncash_InSpecieRollovers"))

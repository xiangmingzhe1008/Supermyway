...
caselist.append('Cash_CR_EmployerPersonalContrib.py')
...
caselist.append('Cash_DR_MemberExpenses.py')
...
caselist.append('NonCash_InSpecieRollovers.py')
caselist.append('NonCash_InternalContributionSplit.py')
caselist.append('NonCash_MemberAccountRollover.py')
caselist.append('NonCash_MemberAccountReclassification.py')

...
class Fund_Initiate(unittest.TestCase):
    def setUp(self):
        ...
        _Filename = (r'..\..\reports\test_Pre_compile_iPortfolio\Pre_compile_iPortfolio_%s.log' % _TF1)
    ...
    def test_cr_nonfinancialassetsale(self):
        try:
            self.i += 1
            driver = self.driver
            self.login()
#             driver.find_element_by_id("ctl00_ContentPlaceHolder1_btnViewFund").click()
            ...
            self.loadingpage()
            time.sleep(1)
            file_path =  r"..\..\data\test_Pre_compile_iPortfolio\cr_nonfinancialassetsale.csv"
            data = open(file_path)
            ...
            for line in range(counts):
                ...
                categorys.find_element_by_xpath("//option[@value='4']").click()
                time.sleep(1)
                ...
                '''This entry type selection is different from others, because the entry type's value is equals to categroy'''
                types = ["html/body/form/div[3]/div[2]/div[2]/div[2]/div[1]/div[2]/div[2]/div[2]/div/table/tbody/tr[6]/td[3]/select/option[2]","html/body/form/div[3]/div[2]/div[2]/div[2]/div[1]/div[2]/div[2]/div[2]/div/table/tbody/tr[6]/td[3]/select/option[3]","html/body/form/div[3]/div[2]/div[2]/div[2]/div[1]/div[2]/div[2]/div[2]/div/table/tbody/tr[6]/td[3]/select/option[4]"]
                driver.find_element_by_xpath(types[line]).click()
            ...
            if self.i <=2:
                self.test_cr_nonfinancialassetsale()
            else:     
                pass
            
if __name__ == '__main__':
    suite = unittest.TestSuite()
    suite.addTest(Fund_Initiate("test_cr_nonfinancialassetsale"))
